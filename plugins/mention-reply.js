...
*Made with ❤️ by ${config.OWNER_NAME || 'BLAZE TEAM'}*`;
    ...
    try {
      ...
      await conn.sendMessage(m.chat, {
        image: { url: config.MENU_IMAGE_URL || "https://files.catbox.moe/n1ap5e.jpg" },
        caption: mentionText,
        contextInfo: {
          ...
          externalAdReply: {
            ...
            title: config.BOT_NAME || 'JAY-JAY MD',
            body: '🤖 Your AI Assistant',
            thumbnailUrl: config.MENU_IMAGE_URL || "https://files.catbox.moe/n1ap5e.jpg",
